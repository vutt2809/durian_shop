export const VI = {
  // Navigation
  'Shop By Category': 'Mua theo loại sầu riêng',
  ...
  'Brand': 'Thương hiệu',
  'Business': 'Kinh doanh',
  'Category': 'Loại sầu riêng',
  'Categories': 'Loại sầu riêng',
  'Products': 'Sản phẩm',
  'Price': 'Giá',
  'Quantity': 'Số lượng',
  'Total': 'Tổng cộng',
  ...
  'Type Email, Phone, Brand Or Status': 'Nhập Email, SĐT, Thương hiệu hoặc Trạng thái',
  ...
  'Category Name': 'Tên loại sầu riêng',
  'Category Slug': 'Slug loại sầu riêng',
  'Category Description': 'Mô tả loại sầu riêng',
